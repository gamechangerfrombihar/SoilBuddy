...
translations = {
    "en": {
       ...
       'welcome_title': "Welcome to SoilBuddy",
        'welcome_desc': "Helping farmers make smarter decisions for their land.",
        'krishi_title': "KrishiUdaan",
        'krishi_desc': "Recommends the best crops to grow for your farm, helping you increase yield and productivity.",
        'amrit_title': "AmritJeevan",
        'amrit_desc': "Calculates precise water requirements to optimize irrigation and promote healthy crop growth.",
        'bharatbot_title': "BharatBot",
        'bharatbot_desc': "Get instant answers to your agricultural queries.",
        'soilscan_title': "SoilScan",
        'soilscan_desc': "Analyze your soil and get personalized crop recommendations.",
        'location_title': "Our Location",
        'location_desc': "Visit us or connect online for more information.",
    ...
    "hi": {
        # Homepage
       'welcome_title': "सॉइलबड्डी में आपका स्वागत है",
        'welcome_desc': "किसानों को उनके खेत के लिए स्मार्ट निर्णय लेने में मदद।",
        'krishi_title': "कृषि उड़ान",
        'krishi_desc': "आपके खेत के लिए सबसे उपयुक्त फसल की सिफारिश करता है, जिससे उपज और उत्पादकता बढ़ती है।",
        'amrit_title': "अमृतजीवन",
        'amrit_desc': "सटीक पानी की आवश्यकता की गणना करता है, जिससे सिंचाई अनुकूल और फसल स्वस्थ रहती है।",
        'bharatbot_title': "भारतबॉट",
        'bharatbot_desc': "अपने कृषि संबंधी सवालों के तुरंत जवाब पाएं।",
        'soilscan_title': "सॉइल स्कैन",
        'soilscan_desc': "अपने मिट्टी का विश्लेषण करें और व्यक्तिगत फसल सिफारिशें प्राप्त करें।",
        'location_title': "हमारा स्थान",
        'location_desc': "अधिक जानकारी के लिए हमें देखें या ऑनलाइन कनेक्ट करें।",
